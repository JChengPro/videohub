...
.toast { max-width: min(360px, 100%); padding: 11px 16px; border: 1px solid var(--mobile-border-strong); border-radius: 8px; background: var(--mobile-overlay); box-shadow: var(--mobile-shadow); color: var(--mobile-text); font-size: 12px; line-height: 1.45; text-align: center; overflow-wrap: anywhere; pointer-events: auto; }
