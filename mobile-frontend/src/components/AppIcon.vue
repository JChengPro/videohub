...
<template>
  <svg :width="size ?? 24" :height="size ?? 24" viewBox="0 0 24 24" :fill="filled ? 'currentColor' : 'none'" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <template v-else-if="name === 'comment'"><path d="M21 12a8 8 0 0 1-8 8H6l-3 2v-7a9 9 0 1 1 18-3Z"/></template>
    ...
    <template v-else-if="name === 'pause'"><path d="M9 5v14M15 5v14"/></template>
    ...
    <template v-else-if="name === 'volume'"><path d="M11 5 6.8 9H3v6h3.8l4.2 4V5Z"/><path d="M15 9a4 4 0 0 1 0 6M17.8 6.5a7.5 7.5 0 0 1 0 11"/></template>
